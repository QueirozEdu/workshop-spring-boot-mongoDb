...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("01/01/2025"), "Lets go!", "Going on a road trip", maria);
        Post post2 = new Post(null, sdf.parse("02/02/2025"), "Good morning", "Woke up feeling great", maria);
